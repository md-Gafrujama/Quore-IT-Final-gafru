      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden mt-20">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="News and Events background featuring Nash Squared content"
            fill
            quality={100}
            priority
      ...
      <main className="px-6 py-12 max-w-3xl mx-auto text-gray-800">
        ...
        <div className="mb-6">
          <Image
            ...
            alt="Bev White, CEO of Nash Squared, recognized as influential woman in UK tech"
            width={800}
            height={600}
        ...
        <article className="prose lg:prose-xl">
          ...
          <p className="text-lg leading-relaxed">
            ...
            <a
              ...
              aria-label="Read full announcement about Bev White's recognition on Nash Squared website"
            >
              Nash Squared official announcement
            </a>
          </p>
        </article>
      </main>
